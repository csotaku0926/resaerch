...
TEST_BUF = Const_Param(alt=540.0, inc=53.2, p=3, s=10, f=17, t_max=90, target_k=30, max_buf=10) # not necessary
...
TEST_MODES = ["ERNC" , "STATIC_R", "GREEDY", "MYOTIC"] # "ERNC" , "STATIC_R", "GREEDY"
...
elif MY_CONST_NAME == 'test_buf':      CONST_PARAM = TEST_BUF
